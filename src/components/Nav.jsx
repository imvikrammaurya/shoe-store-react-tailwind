...
export default function Nav() {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between">
      ...
      >
        <ul className="flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 px-3 py-2 text-lg lg:flex-row lg:space-x-8 lg:border-none lg:bg-transparent">
          {ROUTES.map((route, i) => {
            return (
              <li
